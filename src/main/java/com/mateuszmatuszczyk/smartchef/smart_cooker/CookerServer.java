package com.mateuszmatuszczyk.smartchef.smart_cooker;

import com.mateuszmatuszczyk.smartchef.smart_cooker.CookerServer;
...
public class CookerServer {
    ...
    private class CookerImplementation extends SmartCookerGrpc.SmartCookerImplBase {
        ...
        private boolean cooker_status = false;
        ...
        public void switchOn(com.google.protobuf.Empty request,
            ...
            response.onNext(CookerStatus.newBuilder().setStatusOnOff(cooker_status).setTemperature(cooker_temperature).build());
        ...
        class HeatUp extends TimerTask {
            ...
            public void run() {
                if (cooker_temperature < 100) {
                    ...
                    CookerStatus cooker_status = CookerStatus.newBuilder().setStatusMsg("Heating completed! The cooker is at 100% temperature.").setTemperature(cooker_temperature).build();
                    streamObserver.onNext(cooker_status);
        ...
        class CoolDown extends TimerTask {
            ...
            public void run() {
                if (cooker_temperature > 0) {
                    ...
                    CookerStatus cooker_status = CookerStatus.newBuilder().setStatusMsg("Cooldown completed! The cooker is at 0% temperature.").setTemperature(cooker_temperature).build();
                    streamObserver.onNext(cooker_status);
                    streamObserver.onCompleted();
                    this.cancel();
                }
